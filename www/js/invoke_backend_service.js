...
//insertBarcode ????
function insertBarcode(username, heker, region, subRegion, actionCode, actionDetailedCode, barcodes, firstName, lastName, city, street, streetText, houseNo, signature, phone) {	
	var soapMessage=createBarcodeSoapMessage(username, heker, region, subRegion, actionCode, actionDetailedCode, barcodes, firstName, lastName, city, street, streetText, houseNo, signature, phone);
	$
	.ajax(
			{
				url : serverUrl,
...
function createBarcodeSoapMessage(username, heker, region, subRegion, actionCode, actionDetailedCode, barcodes, firstName, lastName, city, street, streetText, houseNo, signature, phone) {
	var xml='<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tem="http://tempuri.org/"> \
		   <soapenv:Header/> \
				<soapenv:Body> \
	      			<tem:insertBarcode> \
